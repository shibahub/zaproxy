...
public abstract class HttpPanelTextViewEdited implements HttpPanelView, HttpPanelViewModelListener, SearchableHttpPanelView {

    
    public static final String DEFAULT_MESSAGE_CONTAINER_NAME = "HttpMessagePanel";

    public static final String NAME = "HttpPanelTextViewEdited";

    private static final String CAPTION_NAME = "Edited Request" ;
    ...
    public HttpPanelTextViewEdited(AbstractStringHttpPanelViewModel model) {
        this(DEFAULT_MESSAGE_CONTAINER_NAME, model);
    }

    public HttpPanelTextViewEdited(String messageContainerName, AbstractStringHttpPanelViewModel model) {
        this.model = model;
