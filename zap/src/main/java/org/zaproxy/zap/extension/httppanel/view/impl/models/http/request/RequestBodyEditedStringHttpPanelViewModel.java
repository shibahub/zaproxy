...
public class RequestBodyEditedStringHttpPanelViewModel  extends AbstractHttpStringHttpPanelViewModel {
    ...
    public String getData() {
        ...
        System.out.println("edited: "+httpMessage.getRequestBody().toString());
